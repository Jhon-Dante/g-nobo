...
<body>
	<div class="container">
		...
		<div class="row text-center">
			<div class="col-12">
				<p class="intro-text">Hola {{ $user->name }}, en estos momentos esperamos la confirmación de tu banco para procesar tu pedido.</p>
			</div>
			<div class="col-12">
		...
		<div class="row">
			...
			@if($compra->delivery->note)
				<div class="col-12">
					<p class="contact-text">Nota: {{ $compra->delivery->note }}</p>
				</div>
			@endif
		</div>
		<div class="row">
