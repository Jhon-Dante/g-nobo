...
!(function(t, e) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.VueInfiniteLoading = e())
    : (t.VueInfiniteLoading = e());
})(this, function() {
  return (function(t) {
    var e = {};
    function n(i) {
    ...
    function(t, e, n) {
      ...
      function i(t, e) {
        for (var n = [], i = {}, a = 0; a < e.length; a++) {
          var r = e[a],
            o = r[0],
            s = { id: t + ":" + a, css: r[1], media: r[2], sourceMap: r[3] };
    ...
    function(t, e, n) {
          ...
          computed: {
            ...
            spinnerInConfig: function() {
              return d.slots.spinner && "string" == typeof d.slots.spinner
                ...
                : "object" === u()(d.slots.spinner)
                ? d.slots.spinner
                : p[d.props.spinner.toUpperCase()] || p.DEFAULT;
            },
          },
        },
        function() {
        ...
        v = {
          ...
          track: function() {
            ...
            (this.times += 1),
              ...
              this.times > d.system.loopCheckMaxCalls &&
      ...
      var k = f(
        {
          ...
          computed: {
            ...
            slotStyles: function() {
              var t = this,
                e = {};
              return (
                Object.keys(d.slots).forEach(function(n) {
                  var i = y(n);
                  ((!t.$slots[i] && !d.slots[n].render) ||
          ...
          props: {
            distance: { type: Number, default: d.props.distance },
            spinner: String,
            ...
            getScrollParent: function() {
              ...
              return (
                "string" == typeof this.forceUseInfiniteWrapper &&
                  (t = document.querySelector(this.forceUseInfiniteWrapper)),
                t ||
                  ("BODY" === e.tagName
                    ? (t = window)
                    : !this.forceUseInfiniteWrapper &&
      ...
      Object.defineProperty(k, "install", {
        ...
        "undefined" != typeof window &&
          window.Vue &&
          (window.Vue.component("infinite-loading", k), E(window.Vue));
      e.default = k;
    },
  ]);
});
